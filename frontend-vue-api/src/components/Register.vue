    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" @submit.prevent="authStore.handleValidateCode(form)">
        <div>
          ...
          <div class="mt-2">
            <input id="code_otp" name="code_otp" type="text" autocomplete="code_otp"  v-model="form.code_otp" required="" values=""" class="block w-full rounded-md border-0 py-1.5 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
